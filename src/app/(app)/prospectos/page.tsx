  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="font-heading text-2xl font-bold text-slate-900">Pipeline de Búsquedas</h2>
          <p className="text-slate-500 text-sm mt-1">{prospects?.length || 0} búsquedas guardadas</p>
        </div>
      ...
      {(!prospects || prospects.length === 0) ? (
        <div className="bg-white rounded-2xl border border-slate-100 p-16 text-center">
          <span className="material-symbols-outlined text-6xl text-slate-200 mb-4 block">saved_search</span>
          <h3 className="text-xl font-bold text-slate-700 mb-2">Sin búsquedas</h3>
          <p className="text-slate-400 mb-6">Agrega tu primera búsqueda para activar el pipeline.</p>
          <Link href="/prospectos/nuevo"
